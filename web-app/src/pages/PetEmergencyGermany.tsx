                        ...
                        <div className="prose prose-lg text-primary/80 max-w-none">
                            ...
                            <div className="grid md:grid-cols-2 gap-5 my-8 not-prose">
                                ...
                                <Link
                                    ...
                                    aria-label="Ruhr emergency vet guide"
                                    className="block min-h-11 p-5 bg-white border border-primary/10 rounded-2xl hover:border-accent transition-colors"
                                >
                                    <span className="font-bold text-primary block mb-1">Ruhr emergency vet guide</span>
                                    <span className="text-sm text-primary/70">
                                        Official Essen duty line, a current 24-hour clinic, and Dortmund&apos;s rotating duty schedule.
                                    </span>
                                </Link>
                                <Link
                                    to="/guides/emergency-vets-duesseldorf"
                                    aria-label="Düsseldorf emergency vet guide"
                                    className="block min-h-11 p-5 bg-white border border-primary/10 rounded-2xl hover:border-accent transition-colors"
                                >
                                    <span className="font-bold text-primary block mb-1">Düsseldorf emergency vet guide</span>
                                    <span className="text-sm text-primary/70">
                                ...
                                <Link
                                    ...
                                    aria-label="Hannover emergency vet guide"
                                    className="block min-h-11 p-5 bg-white border border-primary/10 rounded-2xl hover:border-accent transition-colors"
                                >
                                    <span className="font-bold text-primary block mb-1">Hannover emergency vet guide</span>
                                    <span className="text-sm text-primary/70">
                                ...
                                <Link
                                    to="/guides/emergency-vets-nuremberg"
                                    aria-label="Nuremberg emergency vet guide"
                                    className="block min-h-11 p-5 bg-white border border-primary/10 rounded-2xl hover:border-accent transition-colors"
                                >
                                    <span className="font-bold text-primary block mb-1">Nuremberg emergency vet guide</span>
                                    <span className="text-sm text-primary/70">
                                ...
                                <Link
                                    to="/guides/emergency-vets-bonn"
                                    aria-label="Bonn emergency vet guide"
                                    className="block min-h-11 p-5 bg-white border border-primary/10 rounded-2xl hover:border-accent transition-colors"
                                >
                                    <span className="font-bold text-primary block mb-1">Bonn emergency vet guide</span>
                                    <span className="text-sm text-primary/70">
