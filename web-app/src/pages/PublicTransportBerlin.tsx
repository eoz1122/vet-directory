    ...
    return (
        <div className="min-h-screen bg-secondary font-sans text-primary">
            <Helmet>
                ...
                <meta property="og:url" content="https://englishspeakinggermany.online/blog/public-transport-with-dogs-berlin" />
                <link rel="canonical" href="https://englishspeakinggermany.online/blog/public-transport-with-dogs-berlin" />
                    ...
                    <article className="lg:flex-1 max-w-4xl">
                        ...
                        <div className="prose prose-lg text-primary/80 max-w-none">
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-sm border border-primary/10 my-6 not-prose">
                                <h3 className="text-lg font-bold mb-2 mt-0 text-primary">🐕 Small Dogs – The “Carrier Rule”</h3>
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-sm border border-primary/10 my-6 not-prose">
                                <h3 className="text-lg font-bold mb-2 mt-0 text-primary">🐕 Larger Dogs – The “Reduced Fare”</h3>
                                <p className="mb-2 text-primary/80">
                            ...
                            <div className="bg-primary/5 p-6 rounded-xl border border-primary/10 mt-8 not-prose">
                                <h3 className="text-lg font-bold text-primary mb-2 mt-0">🎟️ The “Monthly Pass” Bonus</h3>
                                ...
                                <ul className="list-disc pl-5 text-primary/80 mt-0">
                            ...
                            <h3 className="font-bold text-lg text-accent mt-6 mb-2">🛗 Escalators Are a Hard No</h3>
                            ...
                            <div className="bg-primary text-secondary p-8 rounded-2xl my-12 relative overflow-hidden not-prose">
                                ...
                                <div className="mt-8 pt-6 border-t border-white/20">
                                    ...
                                    <Link to="/vets/berlin" className="inline-flex items-center gap-2 bg-white text-primary px-6 py-3 rounded-xl font-bold hover:bg-secondary transition-colors shadow-lg">
                            ...
                            <p className="text-sm italic opacity-70 not-prose">
                                ...
                                <Link to="/blog/public-transport-with-dogs-hamburg" className="text-accent underline ml-1 hover:text-primary">Check out our Hamburg Dog Transport Guide next.</Link>
                            </p>
                        </div>

                        <RelatedPosts currentPath="/blog/public-transport-with-dogs-berlin" />
                    </article>
                </div>
            </main>
