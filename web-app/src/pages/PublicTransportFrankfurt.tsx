                ...
                <article className="prose prose-stone prose-lg max-w-none text-primary/90">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 my-6">
                        <div className="bg-white p-6 rounded-xl border border-primary/5">
                            <h3 className="font-bold text-lg mb-2">🦮 Leash: REQUIRED</h3>
                            <p className="text-sm">
                                This is non-negotiable. All dogs must be kept on a lead and under control at all times.
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-xl border border-primary/5">
                            <h3 className="font-bold text-lg mb-2">😬 The Muzzle Rule</h3>
                            <p className="text-sm">
                    ...
                    <div className="space-y-4 my-6">
                        <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-accent">
                            <h3 className="font-bold text-base mb-1">⏰ The "Main" Rush Hour</h3>
                            <p className="text-sm mb-0">Frankfurt is a business city, and the S-Bahn gets incredibly packed between <strong>07:30–09:00</strong> and <strong>16:30–18:30</strong>. Large dogs are much safer in the "multi-purpose" areas (usually marked with a bicycle or stroller icon) where there is more floor space.</p>
                        </div>
                        <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-red-500">
                            <h3 className="font-bold text-base mb-1 text-red-600">🛗 Elevators vs. Escalators</h3>
                            <p className="text-sm mb-0">Frankfurt’s deeper U-Bahn stations have long escalators. Never take your dog on these. Paw injuries from the metal "teeth" are common. Stick to the <em>Aufzüge</em> (elevators).</p>
                        </div>
                        <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-accent">
                            <h3 className="font-bold text-base mb-1">🚌 Bus Boarding</h3>
                            <p className="text-sm mb-0">On Frankfurt buses, it is customary to board at the front so the driver can see your dog. If the bus is dangerously full, the driver is legally allowed to refuse a large dog to ensure passenger safety.</p>
                        </div>
                    </div>
                    ...
                    <h2 className="text-3xl font-bold text-accent mb-4 mt-12">🏠 A Note from the Sofa</h2>
                    ...
                    <p className="text-sm italic opacity-70 mt-12">
                        ...
                        Check our <Link to="/blog/moving-to-germany-with-pet-2025" className="text-accent underline ml-1 hover:text-primary">Guide to Moving with Pets</Link> for more national travel tips!
                    </p>
