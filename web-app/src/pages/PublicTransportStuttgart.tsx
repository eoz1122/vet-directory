        ...
        <div className="min-h-screen bg-[#F5EBE0] font-sans text-primary">
            ...
            <main className="max-w-3xl mx-auto p-6 md:p-12">
                <article className="prose prose-stone prose-lg max-w-none text-primary/90">
                    ...
                    <p className="bg-accent/10 p-4 rounded-lg text-sm mb-8">
                    ...
                    <div className="space-y-4">
                        <div className="bg-white p-6 rounded-xl border-l-4 border-red-500">
                            <h3 className="text-lg font-bold mt-0 mb-2">Leash: Mandatory</h3>
                            <p className="mb-0">
                        ...
                        <div className="bg-white p-6 rounded-xl border-l-4 border-yellow-500">
                            <h3 className="text-lg font-bold mt-0 mb-2">Muzzle: "Risk-Based"</h3>
                            <p className="mb-2">Stuttgart does not have a blanket muzzle requirement, but they are mandatory for:</p>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-white p-5 rounded-lg shadow-sm">
                            ...
                            <p className="text-sm mb-0">Trains between 7-9am and 5-7pm are packed. It stresses everyone out.</p>
                        </div>
                        <div className="bg-white p-5 rounded-lg shadow-sm">
                            <h4 className="font-bold text-primary mb-2">2. Use the Apps</h4>
                            <p className="text-sm mb-0">Use VVS Mobil or SSB Move to buy tickets. It's cheaper and easier than machines.</p>
                        </div>
                        <div className="bg-white p-5 rounded-lg shadow-sm">
                            <h4 className="font-bold text-primary mb-2">3. Monthly Dog Pass</h4>
                            <p className="text-sm mb-0">If you commute daily, buy a monthly children's ticket (~€60). It saves a fortune.</p>
                        </div>
                        <div className="bg-white p-5 rounded-lg shadow-sm">
                            <h4 className="font-bold text-primary mb-2">4. Bring Water</h4>
                            <p className="text-sm mb-0">Stuttgart summers are hot. Always bring a collapsible bowl and water.</p>
                        </div>
                    </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody>
                                <tr className="border-b border-primary/5">
                                    <td className="p-3 text-sm font-semibold">Dog Ticket</td>
                                    <td className="p-3 text-sm">Children's ticket required (unless in carrier/Deutschlandticket)</td>
                                </tr>
                                <tr className="border-b border-primary/5">
                                    <td className="p-3 text-sm font-semibold">Small Pets</td>
                                    <td className="p-3 text-sm text-green-700 font-bold">FREE (in carrier)</td>
                                </tr>
                                <tr className="border-b border-primary/5">
                                    <td className="p-3 text-sm font-semibold">Service Dogs</td>
                                    <td className="p-3 text-sm text-green-700 font-bold">FREE</td>
                                </tr>
                                <tr className="border-b border-primary/5">
                                    <td className="p-3 text-sm font-semibold">Leash</td>
                                    <td className="p-3 text-sm">Mandatory</td>
                                </tr>
                                <tr className="border-b border-primary/5">
                                    <td className="p-3 text-sm font-semibold">Muzzle</td>
                                    <td className="p-3 text-sm">Required for "dangerous" breeds; carry one just in case</td>
                                </tr>
                                <tr>
                                    <td className="p-3 text-sm font-semibold">Deutschlandticket</td>
