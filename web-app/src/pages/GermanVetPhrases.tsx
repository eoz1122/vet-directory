            ...
            <main className="max-w-4xl mx-auto p-6 md:p-12">
                <div className="mb-12">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-primary mt-2 leading-tight">
                        Our Story: Why I Learned „Durchfall“ the Hard Way
                    </h1>
                    <p className="text-xl text-primary/70 mt-4 font-serif italic">
                        "Stress can make your brain go blank. This is the cheat sheet I keep on my own fridge."
                    </p>
                </div>

                <div className="grid lg:grid-cols-[1fr_250px] gap-12">
                    <article className="prose prose-slate max-w-none prose-headings:text-primary prose-p:text-primary/80 prose-strong:text-primary prose-a:text-accent prose-li:text-primary/80">

                        <p className="lead text-lg">
                            In our <a href="/about">Origin Story</a>, I mentioned standing in a clinic trying to translate “lethargy” on a cracked phone screen while my pet stared at me like, “Please help me.”
                        </p>
                        ...
                        <p className="bg-white p-6 rounded-xl border-l-4 border-accent shadow-sm italic">
                        ...
                        <h2 id="survival-kit" className="scroll-mt-24">🩺 The Expat’s Vet Survival Kit: Essential German Phrases</h2>
                        <p>
                            Even if you’ve found a great practice through our <a href="/">Directory of English-Speaking Vets</a>, stress can make your brain go completely blank in a medical situation.
                        </p>

                        <h3 id="making-appointments" className="scroll-mt-24">1. The Basics: Making the Appointment</h3>
                        <p>
                            Most German vet practices prefer you to call ahead — even for urgent visits.
                        </p>
                        <ul className="bg-secondary/20 p-6 rounded-xl list-none space-y-4">
                        ...
                        <div className="my-6 p-4 bg-white rounded-lg border border-primary/10">
                            <p className="m-0">💡 <strong>Optional but helpful:</strong> <em>Sprechen Sie Englisch?</em> (Do you speak English?) Even if the answer is “a little,” vets will usually try.</p>
                        </div>

                        <h3 id="symptoms" className="scroll-mt-24">2. Describing the Symptoms (The “What’s Wrong?” List)</h3>
                        <p>
                            When the vet asks „Was fehlt dem Kleinen?“ (What’s wrong with the little one?) use these simple building blocks:
                        </p>
                        <div className="grid md:grid-cols-2 gap-4 my-8">
                            <div className="bg-white p-4 rounded-lg border border-primary/5">
                                <p className="font-bold mb-1">Fieber (fever)</p>
                                <p className="text-sm opacity-70 italic">→ „Er hat Fieber.“</p>
                            </div>
                            <div className="bg-white p-4 rounded-lg border border-primary/5">
                                <p className="font-bold mb-1">Durchfall (diarrhea)</p>
                                <p className="text-sm opacity-70 italic">→ Pronounced: DOORKH-fall</p>
                            </div>
                            <div className="bg-white p-4 rounded-lg border border-primary/5">
                                <p className="font-bold mb-1">Erbrechen (vomiting)</p>
                                <p className="text-sm opacity-70 italic">→ „Er hat erbrochen.“</p>
                            </div>
                            <div className="bg-white p-4 rounded-lg border border-primary/5">
                                <p className="font-bold mb-1">Appetitlosigkeit (loss of appetite)</p>
                                <p className="text-sm opacity-70 italic">→ „Sie frisst nicht.“ (She isn’t eating.)</p>
                            </div>
                            <div className="bg-white p-4 rounded-lg border border-primary/5">
                                <p className="font-bold mb-1">Humpeln / Hinken (limping)</p>
                                <p className="text-sm opacity-70 italic">→ „Er hinkt seit gestern.“</p>
                            </div>
                            <div className="bg-white p-4 rounded-lg border border-primary/5">
                                <p className="font-bold mb-1">Juckreiz (itching)</p>
                        ...
                        <h3 id="anatomy" className="scroll-mt-24">3. Anatomy: Where Does It Hurt?</h3>
                        ...
                        <p className="mt-4 italic">💡 Example: „Hier, am Bauch.“ (Here, on the belly.)</p>

                        <h3 id="questions" className="scroll-mt-24">4. Essential Questions to Ask the Vet</h3>
                        <p>These are the questions that matter after the panic settles.</p>
                        <div className="space-y-4">
                            <div className="p-4 bg-secondary/10 rounded-lg">
                                <p className="font-bold m-0 italic">Ist es ansteckend?</p>
                                <p className="text-sm m-0 opacity-70">(Is it contagious?)</p>
                            </div>
                            <div className="p-4 bg-secondary/10 rounded-lg">
                                <p className="font-bold m-0 italic">Braucht er eine Impfung?</p>
                                <p className="text-sm m-0 opacity-70">(Does he need a vaccination?)</p>
                            </div>
                            <div className="p-4 bg-secondary/10 rounded-lg">
                                <p className="font-bold m-0 italic">Muss sie nüchtern bleiben?</p>
                                <p className="text-sm m-0 opacity-70">(Does she need to stay fasted / no food?)</p>
                            </div>
                            <div className="p-4 bg-secondary/10 rounded-lg text-accent border border-accent/20">
                                <p className="font-bold m-0">Nehmen Sie Kartenzahlung an?</p>
                                <p className="text-sm m-0">(Do you accept card payment?)</p>
                            </div>
                        </div>
                        <p className="mt-6 text-sm bg-orange-50 p-4 border border-orange-200 rounded-lg text-orange-900">
                        ...
                        <h3 id="emergency-note" className="scroll-mt-24">💡 Pro Tip: The “Emergency Note”</h3>
                        <p>If your hands are shaking, write down just three things before you leave the house:</p>
                        <ol className="bg-white p-6 rounded-xl border border-primary/5 space-y-4">
                        ...
                        <h2 id="note-from-sofa" className="scroll-mt-24">🌉 A Note from the Sofa</h2>
                        <p>
