        ...
        <div className="min-h-screen bg-[#F5EBE0] font-sans text-primary">
            ...
            <main className="max-w-3xl mx-auto p-6 md:p-12">
                <article className="prose prose-stone prose-lg max-w-none text-primary/90">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-primary/5 my-6 space-y-4">
                        <div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody>
                                <tr>
                                    <td className="p-3 border border-primary/10">You + 1 dog</td>
                                    <td className="p-3 border border-primary/10 font-bold text-green-700">FREE (with your ticket)</td>
                                </tr>
                                <tr>
                                    <td className="p-3 border border-primary/10">You + 2 dogs</td>
                                    <td className="p-3 border border-primary/10">1 children's ticket</td>
                                </tr>
                                <tr>
                                    <td className="p-3 border border-primary/10">You + 3 dogs</td>
                                    <td className="p-3 border border-primary/10">2 children's tickets</td>
                                </tr>
                                <tr>
                                    <td className="p-3 border border-primary/10">Small pet in carrier</td>
                    ...
                    <p className="bg-accent/10 p-4 rounded-lg text-sm mt-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 my-8">
                        <div className="bg-white p-6 rounded-xl border-l-4 border-yellow-500">
                            <h3 className="text-lg font-bold mt-0 mb-2">The Muzzle Rule</h3>
                        ...
                        <div className="bg-white p-6 rounded-xl border-l-4 border-red-500">
                            <h3 className="text-lg font-bold mt-0 mb-2">Strict Requirements</h3>
                            <ul className="list-disc pl-5 text-sm space-y-2 mb-0">
                    ...
                    <p className="bg-primary/5 p-4 rounded-lg text-sm">
                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody>
                                <tr className="border-b border-primary/5">
                                    <td className="p-3 text-sm font-semibold">First Dog</td>
                                    <td className="p-3 text-sm">FREE (with any valid ticket)</td>
                                </tr>
                                <tr className="border-b border-primary/5">
                                    <td className="p-3 text-sm font-semibold">Additional Dogs</td>
                                    <td className="p-3 text-sm">Children's Ticket (Kinderkarte)</td>
                                </tr>
                                <tr className="border-b border-primary/5">
                                ...
                                <tr className="border-b border-primary/5">
                                    ...
                                    <td className="p-3 text-sm">Mandatory for all dogs at all times</td>
                                </tr>
                                <tr className="border-b border-primary/5">
                                    <td className="p-3 text-sm font-semibold">Muzzle</td>
                                    <td className="p-3 text-sm">Mandatory for "risk" dogs; always carry one</td>
                                </tr>
                                <tr>
                                    <td className="p-3 text-sm font-semibold">Deutschlandticket</td>
                                    <td className="p-3 text-sm">One dog free within MVV network</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
