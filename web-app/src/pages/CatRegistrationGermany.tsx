                ...
                <article className="prose prose-stone prose-lg max-w-none text-primary/90">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 my-8">
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-primary/5">
                            <h3 className="text-lg font-bold mb-2 mt-0">TASSO e.V.</h3>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-primary/5">
                            <h3 className="text-lg font-bold mb-2 mt-0">FINDEFIX</h3>
                            <p className="text-sm mb-3">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            <h3 className="text-lg font-bold mb-2 mt-0">Can cats go on the U-Bahn?</h3>
                            <p className="text-sm mb-0">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            <h3 className="text-lg font-bold mb-2 mt-0">What if I move?</h3>
                            <p className="text-sm mb-0">
