...
describe('traffic-focused search metadata', () => {
    ...
    it('answers national night and weekend emergency intent without unsafe triage or hotline claims', async () => {
        ...
        expect(screen.getByRole('link', { name: 'Hannover emergency vet guide' }).getAttribute('href'))
            .toBe('/guides/emergency-vets-hannover');
        expect(screen.getByRole('link', { name: 'Bremen emergency vet guide' }).getAttribute('href'))
            .toBe('/guides/emergency-vets-bremen');
        expect(screen.getByRole('link', { name: 'Leipzig emergency vet guide' }).getAttribute('href'))
            .toBe('/guides/emergency-vets-leipzig');
        expect(screen.getByRole('link', { name: 'Dresden emergency vet guide' }).getAttribute('href'))
            .toBe('/guides/emergency-vets-dresden');
        expect(screen.getByRole('link', { name: 'Nuremberg emergency vet guide' }).getAttribute('href'))
            .toBe('/guides/emergency-vets-nuremberg');
        expect(screen.getByRole('link', { name: 'Karlsruhe emergency vet guide' }).getAttribute('href'))
            .toBe('/guides/emergency-vets-karlsruhe');
        expect(screen.getByRole('link', { name: 'Bonn emergency vet guide' }).getAttribute('href'))
