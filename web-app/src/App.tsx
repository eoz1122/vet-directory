...
const RestrictedDogLawsByCountry = lazy(() => import('./pages/RestrictedDogLawsByCountry'));
...
const PetDentalCareGermany = lazy(() => import('./pages/PetDentalCareGermany'));
...
const EmergencyVetCologneGuide = lazy(() => import('./pages/EmergencyVetCologneGuide'));
const EmergencyVetRuhrGuide = lazy(() => import('./pages/EmergencyVetRuhrGuide'));
const EmergencyVetDuesseldorfGuide = lazy(() => import('./pages/EmergencyVetDuesseldorfGuide'));
const EmergencyVetStuttgartGuide = lazy(() => import('./pages/EmergencyVetStuttgartGuide'));
const EmergencyVetHannoverGuide = lazy(() => import('./pages/EmergencyVetHannoverGuide'));
const EmergencyVetBremenGuide = lazy(() => import('./pages/EmergencyVetBremenGuide'));
...
const EmergencyVetBonnGuide = lazy(() => import('./pages/EmergencyVetBonnGuide'));
const EmergencyVetMuensterGuide = lazy(() => import('./pages/EmergencyVetMuensterGuide'));
const EmergencyVetMainzGuide = lazy(() => import('./pages/EmergencyVetMainzGuide'));
...
const DogLiabilityInsuranceGermany = lazy(() => import('./pages/DogLiabilityInsuranceGermany'));
      ...
      <BrowserRouter>
        ...
        <Suspense fallback={<LoadingFallback />}>
          <Routes>
            ...
            <Route path="/blog/restricted-dog-laws-by-country" element={<RestrictedDogLawsByCountry />} />
            ...
            <Route path="/blog/dog-liability-insurance-germany" element={<DogLiabilityInsuranceGermany />} />
            ...
            <Route path="/guides/emergency-vets-cologne" element={<EmergencyVetCologneGuide />} />
            <Route path="/guides/emergency-vets-ruhr" element={<EmergencyVetRuhrGuide />} />
            <Route path="/guides/emergency-vets-duesseldorf" element={<EmergencyVetDuesseldorfGuide />} />
            <Route path="/guides/emergency-vets-stuttgart" element={<EmergencyVetStuttgartGuide />} />
            <Route path="/guides/emergency-vets-hannover" element={<EmergencyVetHannoverGuide />} />
            <Route path="/guides/emergency-vets-bremen" element={<EmergencyVetBremenGuide />} />
            ...
            <Route path="/guides/emergency-vets-bonn" element={<EmergencyVetBonnGuide />} />
            <Route path="/guides/emergency-vets-muenster" element={<EmergencyVetMuensterGuide />} />
            <Route path="/guides/emergency-vets-mainz" element={<EmergencyVetMainzGuide />} />
            ...
            <Route path="/blog/pet-dental-care-germany" element={<PetDentalCareGermany />} />
