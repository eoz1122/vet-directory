...
export default function Footer() {
    ...
    const navigationLinkClass = 'min-h-11 inline-flex items-center justify-center hover:text-accent transition-colors';
        ...
        <footer className="bg-primary text-secondary py-12 text-center text-sm mt-auto border-t border-primary/10">
            <div className="max-w-4xl mx-auto px-4 space-y-6">
                <nav className="flex justify-center gap-6 md:gap-10 font-bold flex-wrap uppercase tracking-wide text-sm md:text-base">
                    <Link to="/" className={`${navigationLinkClass} gap-2`}>
                    ...
                    <Link to="/blog" className={navigationLinkClass}>Guides</Link>
                    <Link to="/english-speaking-vet-access-germany" className={navigationLinkClass}>Coverage Map</Link>
                    <Link to="/about" className={navigationLinkClass}>About</Link>
                    <Link to="/quality-promise" className={navigationLinkClass}>Quality</Link>
                    <Link to="/contact" className={navigationLinkClass}>Contact</Link>
                ...
                <p className="opacity-60 text-xs md:text-sm">
                    © {currentYear} EnglishSpeakingVets Germany • Made with ❤️ for pets.
                </p>
