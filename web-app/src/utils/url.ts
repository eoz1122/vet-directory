...
export const appendUTM = (url: string | null | undefined): string => {
    ...
    try {
        ...
        urlObj.searchParams.set('utm_source', 'englishspeakinggermany.online');
        ...
        return `${url}${connector}utm_source=englishspeakinggermany.online&utm_medium=directory_link&utm_campaign=referral`;
    }
};
